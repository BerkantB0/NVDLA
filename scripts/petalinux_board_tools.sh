...
export BOARD_SMOKE_BINARY_PATH BOARD_CHECK_SCRIPT_PATH BOARD_TOOLS_PACKAGE_PATH
...

{
  ...
  sha256sum "$BOARD_SMOKE_BINARY_PATH" "$BOARD_CHECK_SCRIPT_PATH" "$BOARD_TOOLS_PACKAGE_PATH"
} | tee -a "$BUILD_LOG"
